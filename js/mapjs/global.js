...
function getUniAlertsDesc(uni_alerts) {
    ...
    for (var i = 0; i < uni_alerts.length; i++) {
        switch (uni_alerts[i]) {
            case ALERT_SOS: desc += "|SOS"; break;
            case ALERT_OVERSPEED: desc += "|Overspeed"; break;
            case ALERT_VIRBRATE: desc += "|Virbrate"; break;
            case ALERT_MOVE: desc += "|Move"; break;
            case ALERT_ALARM: desc += "|Rob"; break;
            case ALERT_INVALIDRUN: desc += "|Invalid Run"; break;
            case ALERT_ENTERGEO: desc += "|Enter Geofence"; break;
            case ALERT_EXITGEO: desc += "|Exit Geofence"; break;
            case ALERT_CUTPOWER: desc += "|Cut Power"; break;
            case ALERT_LOWPOWER: desc += "|Low Power"; break;
            case ALERT_GPSCUT: desc += "|Gps Cut"; break;
            case ALERT_OVERDRIVE: desc += "|Over Drive"; break;
        }
    }
    if(desc !== ''){
    		desc = desc.substr(1, desc.length - 1);
