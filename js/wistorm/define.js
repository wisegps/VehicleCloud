...
var IOT_ALERT_DESC = {};
IOT_ALERT_DESC[IOT_ALERT.ALERT_SOS.toString()] = 'SOS';
IOT_ALERT_DESC[IOT_ALERT.ALERT_OVERSPEED.toString()] = 'Overspeed';
IOT_ALERT_DESC[IOT_ALERT.ALERT_VIRBRATE.toString()] = '震动';
IOT_ALERT_DESC[IOT_ALERT.ALERT_MOVE.toString()] = 'Movement';
IOT_ALERT_DESC[IOT_ALERT.ALERT_ALARM.toString()] = '防盗';
IOT_ALERT_DESC[IOT_ALERT.ALERT_INVALIDRUN.toString()] = 'Invalid Run';
IOT_ALERT_DESC[IOT_ALERT.ALERT_ENTERGEO.toString()] = 'Enter Geofence';
IOT_ALERT_DESC[IOT_ALERT.ALERT_EXITGEO.toString()] = 'Exit Geofence';
IOT_ALERT_DESC[IOT_ALERT.ALERT_CUTPOWER.toString()] = 'Lost Power';
IOT_ALERT_DESC[IOT_ALERT.ALERT_LOWPOWER.toString()] = 'Low Power';
...
IOT_ALERT_DESC[IOT_ALERT.ALERT_OFFLINE.toString()] = 'Offline';
